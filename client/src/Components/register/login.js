            ...
            <section class="bg-inherit min-h-screen flex items-center justify-center">
                ...
                <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5">
                    ...
                    <div class="sm:w-1/2 px-8">
                        ...
                        <p class="text-sm mt-4">If you are already a member, please log in</p>
                        <form action="" class="flex flex-col gap-4">
                            <input class="outline-none p-2 mt-5 rounded-xl border" type="text" name="email" placeholder="Email" />

                            <div class="relative">
                                <input class="outline-none p-2 mt-5 rounded-xl border w-full" type="password" name="password" placeholder="Password" />
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye absolute top-1/2 right-3" viewBox="0 0 16 16 ">
                            ...
                            <button class="bg-gray-300 hover:bg-gray-200 rounded-xl text-black pt-1 pb-1">Login</button>
                        </form>
                        ...
                        <div class=" mt-3 text-xs flex justify-between items-center">
                            ...
                            <button class="bg-white border px-5 py-2 rounded-xl hover:underline">Register</button>
                        </div>
